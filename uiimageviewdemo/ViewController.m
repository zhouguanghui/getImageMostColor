...
- (void)viewDidLoad {
    ...
    UIImage *img  = [UIImage imageNamed:@"11.tiff"];
    [self mostColor:img];
    
    self.view.backgroundColor = [self mostColor:img];
}

- (void)changeImage:(UIButton *)sender
{
    NSString *str = [NSString stringWithFormat:@"%d1.tiff",i];
...
static void RGBtoHSV( float r, float g, float b, double *h, double *s, double *v )
{
    float min, max, delta;
    min = MIN( r, MIN( g, b ));
    max = MAX( r, MAX( g, b ));
...
-(UIColor*)mostColor:(UIImage*)image{
    ...
    NSLog(@"%@",[UIColor colorWithRed:([MaxColor[0] intValue]/255.0f) green:([MaxColor[1] intValue]/255.0f) blue:([MaxColor[2] intValue]/255.0f) alpha:([MaxColor[3] intValue]/255.0f)]);
